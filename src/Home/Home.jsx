...
export default function Home(props) {
  return (
    <div className='ho1'>
      ...
      <div className='don'>
        <a href='https://drive.google.com/file/d/1BPQo4mi1JU4Q6wW6XpF9cTJ3wqHp2N5l/view?usp=drivesdk' ><div className="btn btn-primary mt-3 w-1 "id='but'>Download Resume</div></a>
